...
export default function BaiTapTongHop() {
  ...
  return (
    <div className="grid grid-cols-5">
      <div className="col-span-1 h-full p-3 space-y-2 w-60 dark:bg-coolGray-900 dark:text-coolGray-100">
      ...
      <div className="col-span-4">
        <h3 className="text-center text-purple-500 text-8xl">Menu</h3>
